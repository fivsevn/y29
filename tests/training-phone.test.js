...
import * as variety from '../training/variety.js';
...
test('real controller renders every phone report and exits to final mirror',()=>{
  ...
  const ctx={...variety,...expansion,...content,...narrative,setInterval:()=>0,document,console,Date,Math,setTimeout:()=>0,clearTimeout(){},requestAnimationFrame:()=>0,cancelAnimationFrame(){},crypto:{getRandomValues(a){a[0]=57;return a}}};
  ...
  assert.doesNotMatch(get('game').innerHTML,/phone-music/);
